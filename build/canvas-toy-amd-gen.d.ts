...
declare module "shader/Program" {
    ...
    export const defaultProgramPass: {
        ...
        uniforms: {
            ...
            cameraFar: {
                type: DataType;
                updator: (mesh: Mesh, camera: Camera) => number;
            };
            cameraNear: {
                type: DataType;
                updator: (mesh: Mesh, camera: Camera) => number;
...
declare module "lights/Light" {
    ...
    export abstract class Light extends Object3d {
        ...
        passSingleObjectShadow(mesh: Mesh, material: Material): void;
...
declare module "Scene" {
    ...
    export class Scene {
        ...
        directShadowMaps: Texture2D[];
        directShadowMV: Float32Array;
        directShadowP: Float32Array;
        directShadowSize: Float32Array;
        pointShadowMaps: CubeTexture[];
        pointShadowMV: Float32Array;
        pointShadowP: Float32Array;
        pointShadowSize: Float32Array;
        spotShadowMaps: Texture2D[];
        spotShadowMV: Float32Array;
        spotShadowP: Float32Array;
        spotShadowSize: Float32Array;
        ambientLight: vec3;
        openLight: boolean;
        clearColor: number[];
...
declare module "renderer/forward/ForwardProcessor" {
    ...
    export class ForwardProcessor implements IProcessor {
        ...
        private passShadowInfo(mesh, scene, material, camera);
        private passSpecificShadowArray(mesh, lights, shadowMVArray, shadowPArray, shadowMaps, shadowSizeArray);
    }
}
