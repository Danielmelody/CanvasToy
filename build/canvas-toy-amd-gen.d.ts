...
declare module "shader/shaders" {
    export namespace ShaderSource {
        ...
        const interploters__forward__esm__blur_vert = "attribute vec3 position;\n\nvarying vec4 vProjPos;\n\nvoid main () {\n    gl_Position = vProjPos = vec4(position, 1.0);\n}\n";
        const interploters__forward__esm__depth_frag = "varying vec4 vProjPos;\n\nvoid main () {\n    float depth = vProjPos.z / vProjPos.w * 0.5 + 0.5;\n    gl_FragColor = packFloat1x32(depth);\n}\n";
