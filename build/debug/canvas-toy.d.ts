...
declare namespace CanvasToy {
    ...
    function uniformArray<DecoratorClass>(name: string, type: DataType, updator?: (obj, camera) => {}): (proto: any, key: any) => void;
    function textureArray<DecoratorClass>(name: string): (proto: any, key: any) => void;
    function texture<DecoratorClass>(name: string): (proto: any, key: any) => void;
    function linkdef(name: string, value?: string): (proto: any, key: any) => void;
...
declare namespace CanvasToy {
    class ShadowPreProcess implements IProcessor {
        gl: WebGLRenderingContext;
        ext: WebGLExtension;
