...
declare namespace CanvasToy {
    ...
    function linkdef(...defineNames: string[]): (proto: any, key: any) => void;
...
declare namespace CanvasToy {
    ...
    class Program implements IProgramPass {
        ...
        addTextureArray(samplerArray: string, array: Texture[]): void;
        addTexture(sampler: string, getter: (mesh, camera, material) => Texture): void;
        addUniformArray(arrayNameInShader: any, uniforms: IUniformArray): void;
